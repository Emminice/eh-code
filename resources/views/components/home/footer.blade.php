    ...
    <section class="py-10 bg-gray-900 sm:pt-16 lg:pt-24">
        <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
            ...
            <div class="flex flex-wrap items-center justify-between">
                <img class="h-8 md:order-1" src="{{ asset('img/eh-logoo.png') }}" alt="" />
                <p class="w-full mt-8 text-2xl font-bold text-center text-gray-100 md:mt-0 md:w-auto md:order-2">EH CODE.</p>
                ...
                <ul class="flex items-center space-x-3 md:order-3">
                    ...
                    <li>
                        <a href="#" title="" class="flex items-center justify-center text-white transition-all duration-200 bg-transparent border border-gray-700 rounded-full w-7 h-7 focus:bg-blue-600 hover:bg-blue-600 hover:border-blue-600 focus:border-blue-600">
                            <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColour">
                                <path 
                                fill="#ffffff"
                                    fill-rule="evenodd"
                                    cliprule="evenodd"
                ...
                <p class="w-full mt-8 text-sm mx-auto text-center text-gray-100 md:mt-0 md:w-auto md:order-2">© Copyright 2023. All rights reserved by EH-CODE.</p>
            </div>
        </div>
    </section>